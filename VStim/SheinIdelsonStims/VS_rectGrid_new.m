classdef VS_rectGrid_new < VStim
    ...
    methods
        ...
        function obj=run(obj)
            ...
            Screen('DrawTexture',obj.PTB_win,imgTex(obj.pos(1),obj.rectLuminosity(obj.luminosities(1))),[],obj.visualFieldRect,obj.rotation);
            obj.applyBackgound;
        ...
        function obj=CMShowGrid(obj,srcHandle,eventData,hPanel) %%%FIX FOR MULTIPLE LUMINOCITIES
            ...
            I=ones(obj.visualFieldRect(3)-obj.visualFieldRect(1),obj.visualFieldRect(4)-obj.visualFieldRect(2)).*obj.visualFieldBackgroundLuminance;
            for i=1:nPositions
                I(obj.rectData.X1(obj.pValidRect(i)):obj.rectData.X3(obj.pValidRect(i)),obj.rectData.Y1(obj.pValidRect(i)):obj.rectData.Y3(obj.pValidRect(i)))=obj.rectLuminosity(1);
            end
            ...
            for i=1:nPositions
                ...
                Screen('DrawText', obj.PTB_win, num2str(i),obj.visualFieldRect(1)+obj.rectData.Y1(obj.pValidRect(i)),obj.visualFieldRect(2)+obj.rectData.X1(obj.pValidRect(i)),[min(obj.rectLuminosity(nLuminosities)+50,255) 0 0],[]);
